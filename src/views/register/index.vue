<template>
  ...
  <div class="container">
    ...
    <div class="box">
      <!-- 标题的盒子 -->
      <div class="title"></div> <!-- 1.标签样式 2.数据绑定 3.js交互 4.传给后端-->
      <!-- 注册的表单区域 -->
      <!-- 根据设计要求 需要3个输入框和1个注册按钮 1个登录按钮 -->
      <el-form ref="form" :model="form" :rules="rulesObj"> <!--  //第一步:rules="校验规则对象" -->
        <el-form-item prop="username"> <!-- 第二步:给每个需要校验的表单域来一个prop -->
        ...
        <el-form-item prop="repassword">
          <el-input
            v-model="form.repassword" placeholder="请再次输入密码" type="password"></el-input>
        </el-form-item>
        <el-form-item>
